...
history_initials_blue = np.zeros((how_many_iters, 1000))
history_initials_orange = np.zeros((how_many_iters, 1000))

history_final_blue_fair = np.zeros((how_many_iters, how_much_history, 1000))
history_final_orange_fair = np.zeros((how_many_iters, how_much_history, 1000))
history_cutoff_fair = np.zeros((how_many_iters, how_much_history, 2))

history_final_blue_unfair = np.zeros((how_many_iters, how_much_history, 1000))
history_final_orange_unfair = np.zeros((how_many_iters, how_much_history, 1000))
history_cutoff_unfair = np.zeros((how_many_iters, how_much_history, 2))
